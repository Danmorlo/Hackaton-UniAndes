        ...
        return (
            <div className="balance">
                ...
                <div className="transactions">
                    <Transaction alt={"cafe"} precio={12350} cantidad={300} img={"https://img.etimg.com/thumb/msid-69997940,width-1200,height-900,resizemode-4,imgsize-322599/coffee.jpg"}/>
